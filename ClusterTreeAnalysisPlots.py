...
inputname = "ClusterTreeAnalysis.root"
...
h_hit_channel_phi.SetTitle("Cluster Tree")
h_hit_channel_phi.GetXaxis().SetTitle("Channel number")
...
myc.Update()
myc.SaveAs("clusterPlots/h_hit_channel_phi.eps")
myc.SaveAs("clusterPlots/h_hit_channel_phi.png")
myc.Close()
'''
...
h_hit_channel_phi_oneLayer.SetTitle("Cluster Tree Sector 3, Layer 2")
...
myc.Update()
myc.SaveAs("clusterPlots/h_hit_channel_phi_oneLayer_sector3_layer2.eps")
myc.SaveAs("clusterPlots/h_hit_channel_phi_oneLayer_sector3_layer2.png")
myc.Close()
...
h2_hit_channel_phi_byLayers.SetTitle("Cluster Tree")
...
myc.Update()
myc.SaveAs("clusterPlots/h2_hit_channel_phi_byLayers.eps")
myc.SaveAs("clusterPlots/h2_hit_channel_phi_byLayers.png")
myc.Close()
'''

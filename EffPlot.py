...
h_eff_channel_forOneLayer.SetTitle("Sector -5, Layer 2")
...
myc.Update()
myc.SaveAs("effplots/h_eff_channel_forOneLayer_Sector-5Layer2.eps")
myc.SaveAs("effplots/h_eff_channel_forOneLayer_Sector-5Layer2.png")
myc.Close()

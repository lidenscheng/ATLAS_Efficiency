...
#h2_eff_phi = inputfile.Get("eff_layer_phi")
#h2_eff_eta = inputfile.Get("eff_layer_eta") 

h_eff_layer_phi = inputfile.Get("eff_layer_phi")
...
phi_eff_lower140 = array('d', [0.943514, 0.829644, 0.921973, 0.86068, 0.930869])
...
eta_eff_lower140 = array('d', [0.925652, 0.898462, 0.909173, 0.901848, 0.903174])
...
myc= ROOT.TCanvas("myc", "myc", 1300, 600)
myc.SetMargin(0.06,0.03,0.1,0.05)
h_eff_layer_phi.SetStats(ROOT.kFALSE)
h_eff_layer_phi.SetTitle("")
#h_eff_layer_phi.SetMaximum(1.)
h_eff_layer_phi.SetFillColor(ROOT.kRed-9)
h_eff_layer_phi.SetLineColor(ROOT.kRed+2)
h_eff_layer_phi.GetXaxis().SetTitle("Phi")
#h_eff_layer_phi.GetXaxis().SetNdivisions(61)
h_eff_layer_phi.GetYaxis().SetTitle("Efficiency")
h_eff_layer_phi.GetYaxis().SetTitleOffset(0.7)
h_eff_layer_phi.GetYaxis().SetTitleSize(0.04)
h_eff_layer_phi.Draw("HIST")
myc.Update()
#error_h_eff_layer_phi = ROOT.TGraphAsymmErrors(h_eff_layer_phi)
#error_h_eff_layer_phi.SetFillStyle(3001)
#error_h_eff_layer_phi.SetFillColor(ROOT.kRed+2)
#error_h_eff_layer_phi.Draw("2 SAME")
myc.Update()
myc.SaveAs("effplots/h_eff_layer_phi.eps")
myc.SaveAs("effplots/h_eff_layer_phi.png")
myc.Close()
...
myc= ROOT.TCanvas("myc", "myc", 1000, 800)
myc.SetMargin(0.08,0.15,0.1,0.03)
h2_eff_phi.SetStats(ROOT.kFALSE)
h2_eff_phi.SetTitle("")
h2_eff_phi.GetXaxis().SetTitle("Phi")
h2_eff_phi.GetYaxis().SetTitle("Sector number")
h2_eff_phi.GetYaxis().SetTitleOffset(0.9)
h2_eff_phi.GetYaxis().SetTitleSize(0.04)
h2_eff_phi.GetZaxis().SetTitle("Hits")
h2_eff_phi.GetZaxis().SetTitleOffset(1.3)
h2_eff_phi.Draw("COLZ0")
myc.Update()
myc.SaveAs("effplots/h2_eff_phi.eps")
myc.SaveAs("effplots/h2_eff_phi.png")
myc.Close()

myc= ROOT.TCanvas("myc", "myc", 1000, 800)
myc.SetMargin(0.08,0.15,0.1,0.03)
h2_eff_eta.SetStats(ROOT.kFALSE)
h2_eff_eta.SetTitle("")
h2_eff_eta.GetXaxis().SetTitle("Eta")
h2_eff_eta.GetYaxis().SetTitle("Sector number")
h2_eff_eta.GetYaxis().SetTitleOffset(0.9)
h2_eff_eta.GetYaxis().SetTitleSize(0.04)
h2_eff_eta.GetZaxis().SetTitle("Hits")
h2_eff_eta.GetZaxis().SetTitleOffset(1.3)
h2_eff_eta.Draw("COLZ0")
myc.Update()
myc.SaveAs("effplots/h2_eff_eta.eps")
myc.SaveAs("effplots/h2_eff_eta.png")
myc.Close()
'''
